...
def test_page_token(account_id, token):
    ...
    if campaign_id == None:
        ...
        # if error_message['code'] in error_codes_limit_reached or cm_error_message['code'] in error_codes_limit_reached:
        #     limit_reached = True
        # if error_message['code'] in error_code_expired or cm_error_message['code'] in error_code_expired:
        #     expired = True
    return (expired, limit_reached)
